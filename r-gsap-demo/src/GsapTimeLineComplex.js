...
class GsapTimeLineComplex extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 mt-3">
            ...
            <p className="lead">
              Uses the <strong>ref</strong> callback to create references for a group of elements in the app.
              Then using the <strong>componentDidMount</strong> method, creates a timeline sequence that can
            ...
            <div className="demoWrapper">
              ...
              <div className="content" ref={(div) => (this.content = div)}></div>
              ...
              <div className="info">
                ...
                <p className="description" ref={(p) => (this.description = p)}>
                  Animate colors, beziers, css properties, arrays, scrolls and lots more. Round values,
                  smoothly reverse() on the fly, use relative values, employ virtually any easing equation,
                  and manage conflicting tweens like a pro. GSAP does all this and much more with ease.
                </p>
              </div>
            ...
            <div className="my-3 btn-group">
              <button className="btn gsap-btn" onClick={() => this.logoTl.play()}>
                Play
              </button>
              <button className="btn gsap-btn" onClick={() => this.logoTl.pause()}>
                Pause
              </button>
              <button className="btn gsap-btn" onClick={() => this.logoTl.reverse()}>
                Reverse
              </button>
              <button className="btn gsap-btn" onClick={() => this.logoTl.restart()}>
                Restart
              </button>
            </div>
          </div>
...
export default GsapTimeLineComplex;
